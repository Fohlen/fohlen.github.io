...
This gives us back a JavaScript output following the specified schema, namely a `books` array with `book` objects. An excerpt of the result is provided below:
